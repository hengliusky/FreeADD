...
<table>
    ...
    <!-- 第二行：文本 -->
    <tr>
        <td align="center" valign="middle" height="60">The cat is screaming, the snake is crawling.</td>
        <td align="center" valign="middle" height="60">Two giraffes are slowly lowering their heads.</td>
        <td align="center" valign="middle" height="60">The little girl is crawling forward, and the dog is running forward.</td>
        <td align="center" valign="middle" height="60">The boy lookes at the girl, and the girl is smiling.</td>
        <td align="center" valign="middle" height="60">The cow is eating grass and the dog is running forward.</td>
        <td align="center" valign="middle" height="60">The boy takes off his glasses, and the girl is smiling.</td>
        <td align="center" valign="middle" height="60">The duck in front swam forward, the middle duck shook its head, and the last duck inserted its head into the water.</td>
        <td align="center" valign="middle" height="60">The boy is reading a book while the dog opens its mouth and barks.</td>
    </tr>
